  ...
  def tests = Tests {
    ...
    val dbClient = new DbClient.Connection(
      java.sql.DriverManager
        .getConnection("jdbc:sqlite::memory:", "sa", ""),
      new Config {
    ...
    db.updateRaw(os.read(os.pwd / "scalasql-tests/src/test/resources" / "world-schema.sql"))
    db.updateRaw(os.read(os.pwd / "scalasql-tests/src/test/resources" / "world-data.sql"))
