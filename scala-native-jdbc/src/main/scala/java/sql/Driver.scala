...
trait Driver {
   ...
   */
  def getPropertyInfo(url: String, info: java.util.Properties): scala.Array[DriverPropertyInfo]

  /**
   * Gets information about the possible properties for this driver.
   */
  def getPropertyInfo(url: String, info: Map[String, String]): scala.Array[DriverPropertyInfo]
...
/**
 * DriverPropertyInfo is used to provide information about the properties
 * that can be specified when connecting to a database.
 */
